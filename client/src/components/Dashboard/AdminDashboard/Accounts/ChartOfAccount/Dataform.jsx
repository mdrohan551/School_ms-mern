...
const Dataform = () => {
    return (
        <div className="rounded-2xl shadow-xl border border-gray-200 p-5 w-full bg-white space-y-8">
            ...
            <div
                className="max-w-full mx-auto shadow rounded-2xl p-3 mr-0 lg:mr-7 flex flex-col lg:flex-row items-start lg:items-center justify-between text-start space-y-3 lg:space-y-0 lg:space-x-5 mt-3 bg-gray-400 border-b">
                <div
                    className="w-full flex flex-col sm:flex-row justify-between items-start sm:items-center px-4 md:px-10 gap-4 text-white">
                    <h1 className="text-xl font-medium">Name Of Head</h1>
